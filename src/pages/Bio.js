...
const Bio = () => (
  <div className="bio wrapper">
    <h2>Hi.</h2>
    <h3>I'm Peter.</h3>
    <p>I am passionate about using technology and data as a tool for storytelling, insight, communication, and understanding - in particular using data and technology to navigate complex systems, foster empathy at scale, drive organizational innovation and ignite cultural change.</p>
